...
- [o] Use GitHub's website to add your project manager as collaborator on **your fork**.
- [o] **Clone your forked version** of the repository (**Not Lambda's**!).
- [o] Create a new branch: `git checkout -b <firstName-lastName>`.
- [o] Commit changes to your `<firstName-lastName>` branch.
- [o] Push often to your branch: `git push origin <firstName-lastName>`.
